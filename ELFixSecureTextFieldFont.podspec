Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/prolificinteractive/ELFixSecureTextFieldFont.git"
  s.license      = "MIT"
  s.author       = { "Vladimir Lyukov" => "v.lyukov@gmail.com" }
  s.source       = { :git => "https://github.com/prolificinteractive/ELFixSecureTextFieldFont.git", :tag => s.version.to_s }
  s.platform     = :ios
